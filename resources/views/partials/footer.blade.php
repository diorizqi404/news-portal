    <footer class="bg-gray-100 border-t border-gray-300 mt-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 class="text-lg font-semibold text-gray-900 mb-4">News Portal</h3>
            <p class="text-gray-600 text-sm">
              Sumber berita terpercaya untuk informasi terkini dari Dunia dan untukmu.
            </p>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm text-gray-600">
              ...
              <li><a href="#" class="hover:text-blue-600">Olahraga</a></li>
            </ul>
          </div>
